        ...
        uglify: {
            ...
            silu: {
                files: {
                  ...
                  'app/js/prod/step3/set3.min.js': ['<%= project.app %>/js/lib/property-carousels.js','<%= project.src %>/scss/js/minify/set3/custom.1.12.min.js','<%= project.app %>/js/lib/jquery-1.8.0.min.js','<%= project.app %>/js/lib/jquery-ui.js','<%= project.app %>/js/lib/bootstrap-multiselect.js','<%= project.src %>/scss/js/minify/set3/custom.1.8.min.js']
                }
            }
        },
        // OPEN
